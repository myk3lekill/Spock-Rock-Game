...
/*HTML onclick functions are not defined in the global scope but in the local scope of script.js. So we need to implement these functions in the global scope of the window object:*/
window.select = select; //Now select() is avaiabale into the global scope;
window.resetAll = resetAll; //Now resetAll() is aiable into the gloab scope;